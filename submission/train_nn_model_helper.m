...
function results = train_nn_model_helper(inputs, label_values, num_hidden, num_classes, num_epochs, weights)
...
momentum = 0.9;   %% the momentum coefficient
...
for epoch = 1:num_epochs
    ...
    results = run_nn_model_helper(inputs, weights);
